    ...
    public function index()
    {
        ...
        foreach ($dataTmp as $key => $row) {
            ...
            $dataTr[] = [
                ...
                'action' => '
                    <a href="' . route('admin_permission.edit', ['id' => $row['id']]) . '"><span title="' . trans('permission.admin.edit') . '" type="button" class="main-action btn btn-flat btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
...
//menu_right
        $data['menu_right'] = '
                        <div class="btn-group pull-right" style="margin-right: 10px">
                           <a href="' . route('admin_permission.create') . '" class="main-action btn  btn-success  btn-flat" title="New" id="button_create_new">
