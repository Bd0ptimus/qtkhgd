    ...
    public function index()
    {
        ...
        foreach ($dataTmp as $key => $row) {
            ...
            $dataTr[] = [
                ...
                'updateted_at' => $row['updated_at'],
                'action' => (in_array($row['id'], SC_GUARD_ROLES) ? '' : '
                    <a href="' . route('admin_role.edit', ['id' => $row['id']]) . '"><span title="' . trans('role.admin.edit') . '" type="button" class="main-action btn btn-flat btn-primary"><i class="fa fa-edit"></i></span></a>&nbsp;
...
//menu_right
        $data['menu_right'] = '
                        <div class="btn-group pull-right" style="margin-right: 10px">
                           <a href="' . route('admin_role.create') . '" class="main-action btn  btn-success  btn-flat" title="New" id="button_create_new">
