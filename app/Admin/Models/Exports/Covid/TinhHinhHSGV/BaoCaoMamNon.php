...
class BaoCaoMamNon implements FromView, WithTitle, WithStyles, WithColumnWidths
{
    protected $school;
    protected $classes;
    protected $date;
    ...
    public function view(): View
    {
        ...
        return view('exports.covid_reports.thong_ke_tong_hop.mamnon', [
            'school' => $this->school,
