...
class ExportCovidReportProvinceDistrict extends BaseExport
{
    protected $province;
    protected $reports;
    protected $from_date;
    ...
    public function view(): View
    {
        ...
        return view('exports.covid_export_province_district', [
    ...
    {
        return $this->download('Thống kê tình hình phòng chữa bệnh Covid Sở các phòng.xls');
    }
}