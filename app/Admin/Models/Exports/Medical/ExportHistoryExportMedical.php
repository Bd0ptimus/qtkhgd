...
class ExportHistoryExportMedical extends BaseExport
{
    protected $school;
    ...
    public function view(): View
    {
        ...
        $tableName = Str::upper('Danh sách lịch sử xuất thuốc');
        $extraInformation = 'Ngày xuất danh sách: ' . Carbon::now()->format('d/m/Y');

        return view('exports.medicine.history_export_medical', [
