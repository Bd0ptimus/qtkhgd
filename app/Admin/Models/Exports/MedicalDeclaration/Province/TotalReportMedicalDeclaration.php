...
class TotalReportMedicalDeclaration extends BaseExport implements WithStyles, WithTitle, WithEvents
{
    ...
    public function __construct($province, $data)
    {
    ...
    public function view(): View
    {
        ...
        return view('exports.medical_declaration.province.total_report_medical_declaration', [
            'tableName' => $tableName,
    ...
    public static function afterSheet(AfterSheet $event)
    {
        ...
        self::defaultStyleHeader($sheet, 8);
        self::defaultStyleOther($sheet, 8, $sheet->getHighestDataColumn(), $sheet->getHighestRow() - 3, ['is_align' => false]);
    }
}