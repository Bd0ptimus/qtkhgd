...
class ExportStudentVaccineForm implements FromCollection, WithMapping, WithHeadings, WithEvents, WithColumnFormatting, WithColumnWidths
{
    ...
    public function __construct($school_id, $class)
    {
    ...
    {
        $vaccineHistory = $student->vaccineHistory->all()[0] ?? null;
