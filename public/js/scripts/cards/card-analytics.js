  ...
  var $white = '#fff';
   ...
   var sessionChart = new ApexCharts(
    ...
    var orderChartoptions = {
        ...
        series: [70, 52, 26],
        labels: ['Bình thường', 'Béo phì', 'Suy dinh dưỡng'],

    }

    var weightChannelsChart = new ApexCharts(
        document.querySelector("#weight-channels-chart"),
        orderChartoptions
    );

    var heightChannelsChart = new ApexCharts(
        document.querySelector("#weight-channels-chart"),
        orderChartoptions
    );

    var whChannelsChart = new ApexCharts(
        document.querySelector("#wh-channels-chart"),
        orderChartoptions
    );

    weightChannelsChart.render();
    heightChannelsChart.render();
    whChannelsChart.render();
