                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            ...
                            <form class="d-flex flex-wrap mb-1" method="GET"
                                  action="{{ route('admin.agency.districts') }}">
                                <div class="mr-1">
                                            ...
                                            <td>
                                                @if( Admin::user()->inRoles(['administrator', 'customer-support']))
                                                    ...
                                                    @if (count($district->users) > 0)
                                                        ...
                                                        <a type="button" id="create_sgd_account"
                                                           name='{{ $district->gso_id }}' class="btn btn-flat btn-info"
                                                           href="{{  route('school.index') }}?provinceId={{$district->province->id}}&districtId={{$district->id}}">
                                                            <i class="fa fa-bars" aria-hidden="true"></i> DS Trường
                                                        </a>
                                                        <a type="button" id="create_sgd_account"
                                                           name="{{ $district->gso_id }}"
                                                           class="main-action btn btn-flat btn-warning"
                                                    ...
                                                    @else
                                                        <a type="button" id="create_sgd_account"
                                                           name='{{ $district->gso_id }}'
                                                           class="main-action btn btn-flat btn-success"
                                                           href="{{  route('admin_user.create_pgd_account', ['gso_id' => $district->gso_id])  }}">
                                                            <i class="fa fa-plus" aria-hidden="true"></i> Tạo TK
                                                        </a>
                                                    @endif
                                                @endif
                                            </td>
