  ...
  <div class="row">
    <div class="col-12">
      <div class="alert alert-warning" role="alert">
        <strong>Bước 1. </strong> Tải <a href="/demo_imports/file_import_truong.xls">File mẫu</a> về máy. <br>
      ...
      <div class="alert alert-info" role="alert">
        <strong>Lưu ý: </strong> Khi có bất kỳ lỗi nào, hệ thống sẽ hiện cảnh báo. Bạn vui lòng chỉnh sửa lại dữ liệu theo hướng dẫn của cảnh báo và tiến hành upload lại.
      </div>
    </div>
  </div>
    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Chọn file dữ liệu trường</h4>
        </div>
        <div class="card-content">
          <div class="card-body">
            <form enctype="multipart/form-data" method="POST" action="{{  route('admin.agency.districts.import_school', ['id' => $district->id ]) }}" class="form-horizontal" >
                @csrf
