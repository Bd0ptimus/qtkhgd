                                ...
                                <div class='row'>
                                    ...
                                    <div class="col-sm-3">
                                        <select class="form-control parent select2 filter-district" style="width: 100%;"
                                                ...
                                                name="district">
                                            @if(Admin::user()->inRoles([ROLE_ADMIN, ROLE_CM, ROLE_SO_GD]))
                                                <option value=""><a href="#">Tất cả</a></option>
                                            @endif
...
@section('page-script')
    ...
    <script>
        ...
        columnDefs.push({
            ...
            cellRenderer: function (params) {
                return '<a type="button" style="margin: 2px" class="btn btn-flat btn-info waves-effect waves-light" href="' + params.value.school + '"><span title="Quản lý trường"><i class="fa fa-bars" aria-hidden="true"></i></span></a>' +
                    '<a type="button" style="margin: 2px" href="' + params.value.route_edit + '" class="main-action btn btn-flat btn-success waves-effect waves-light"><span title="Sửa"><i  class="fa fa-edit" aria-hidden="true"></i></span></a>' +
                    '<a type="button" style="margin: 2px" class="main-action btn-delete-school btn btn-flat btn-danger" href="#" data-id="' + params.value.id + '"><span title="Xóa"><i  class="fa fa-trash" aria-hidden="true"></i></span></a>'
            }
        })
        ...
        $('.filter-province').change(function () {
            ...
            url = updateParameter(url, 'districtId', '');
            window.location.href = url;
        });

        $('.filter-district').change(function () {
            let optionSelected = $(this).find("option:selected");
            window.location.href = updateParameter(window.location.href, 'districtId', optionSelected.val()?optionSelected.val() : '');
        });
