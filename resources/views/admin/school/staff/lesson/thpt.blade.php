                                            ...
                                            <div class="card-body">
                                                <div class="accordion" id="accordionExample">
                                                    <div class="table-responsive">
                                                        <table class="table zero-configuration" id="teacherPlanLessons">
                                                            <thead>
                                                                <tr>
                                                                    <th scope="col">STT</th>
                                                                    ...
                                                                    <th scope="col" style="width: 200px">Bài học</th>
                                                                    <th scope="col" style="width: 200px">Tên bài học</th>
