                                        ...
                                        <div class="card card-school-plan collapse-icon accordion-icon-rotate">
                                            ...
                                            <div class="card-body">
                                                <div class="accordion" id="accordionExample">
                                                                    ...
                                                                    ` <table class="table table-bordered table-striped text-nowrap" id="teacherPlanLessons">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <input {{$teacherPlan->status == PLAN_APPROVED ? 'readonly' : '' }} class="date" id="date-{{ $lesson->id }}" data-id="{{ $lesson->id }}" data-start="{{ $lesson->start_date }}" data-end="{{ $lesson->end_date }}" name="lessons[{{ $lesson->id }}][{{ $field }}]">
                                                                                </td>
                                                                                @else
                                                    ...
                                                    <div class="collapse-margin">
                                                        <div class="card-header" id="headingFour" data-toggle="collapse" role="button" data-target="#collapse6" aria-expanded="false" aria-controls="collapseFour">
                                                            <span class="lead collapse-title">
                                                                II. Nhiệm vụ khác
                                                            </span>
                                                        </div>
