                ...
                <form method="post" accept-charset="UTF-8" class="form-horizontal"
                    ...
                    <div class="box-body">
                        <div class="fields-group">
                            ...
                            <div class='row'>
                                @if(isset($target) && 0 == count($target->staffTargets))
                                    <div class="col-sm-12 {{ $errors->has('solution') ? ' has-error' : '' }}">
                                        <label for="result" class="control-label">Kết quả %<sup class="text-danger">*</sup></label>
                                        <div class="input-group">
                                            <input type="number" max='100' min='0' name="result"
                                                value="{{ old('result',$target['result']??'')}}"
                                                class="form-control" placeholder="Kết quả"/>
                                        </div>
