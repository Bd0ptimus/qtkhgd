...
<section id="component-swiper-centered-slides-2">
    <div class="card">
        ...
        <div class="card-content">
            <div class="card-body pt-0">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-text"><a target="_blank"href="{{ route('school.target.index', ['id' => $school->id])}}">Bảng chỉ tiêu cá nhân</a></div>
                    </div>
                </div>
                </div>
            </div>
                ...
                <div class="card-body pt-0">
                    <div class="swiper-centered-slides-2 swiper-container p-1">
                        ...
                        <div class="swiper-slide rounded py-1 px-1 d-flex">
                            ...
                            <div class="swiper-slide rounded swiper-shadow py-1 px-1 d-flex">
                                <div class="swiper-text"><a target="_blank" href="{{ route('school.regular_group.review_teacher_plans', ['id' => $school->id, 'rgId' => $staff->manageGroup->regular_group_id]) }}">Duyệt kế hoạch giáo viên</a></div>
                            </div>

                            <div class="swiper-slide rounded swiper-shadow py-1 px-1 d-flex">
                                <div class="swiper-text"><a target="_blank" href="{{ route('school.regular_group.review_teacher_lessons', ['id' => $school->id, 'rgId' => $staff->manageGroup->regular_group_id]) }}">Duyệt kế hoạch bài giảng</a></div>
                            </div>

                            <div class="swiper-slide rounded swiper-shadow py-1 px-1 d-flex">
                                <div class="swiper-text"><a target="_blank" href="{{ route('school.regular_group.teacher_plans', ['id' => $school->id, 'rgId' => $staff->manageGroup->regular_group_id]) }}">Xem kế hoạch giáo viên</a></div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Cấu hình chuyên môn -->
        <div class="card-header">
            <h4 class="card-title">Kế hoạch giảng dạy cá nhân</h4>
        </div>
        <div class="card-content">
            <div class="card-body pt-0">
                <div class="swiper-centered-slides-2 swiper-container p-1">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide rounded swiper-shadow py-1 px-1 d-flex">
                            <div class="swiper-text"><a target="_blank"
                                    href="{{ route('school.staff.timetable', ['school_id' => $school->id, 'staffId' => Admin::user()->staffDetail->id])}}">Lịch công tác</a></div>
                        </div>

                        <div class="swiper-slide rounded swiper-shadow py-1 px-1 d-flex">
                            <div class="swiper-text"><a target="_blank" href="{{ count($staffGroups) > 0 ? route('school.staff.plan.index', ['school_id' => $school->id, 'rgId' => $staffGroups[0]->id, 'staffId' => Admin::user()->staffDetail->id]) : route('school.staff.regular_group', ['school_id' => $school->id, 'staffId' => Admin::user()->staffDetail->id ]) }}">Kế hoạch giảng dạy</a></div>
                        </div>

                        <div class="swiper-slide rounded swiper-shadow py-1 px-1 d-flex">
                            <div class="swiper-text"><a target="_blank" href="{{ count($staffGroups) > 0 ? route('school.staff.teacher_lesson.index', ['school_id' => $school->id, 'staffId' => Admin::user()->staffDetail->id]) : route('school.staff.regular_group', ['school_id' => $school->id, 'staffId' => Admin::user()->staffDetail->id ]) }}">Kế hoạch bài dạy</a></div>
                        </div>
                    </div>
                </div>
            </div>
