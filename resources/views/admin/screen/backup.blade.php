  ...
  <div class="col-md-12">
      <div class="card">
          ...
          <div class="card-content">
              <div class="card-body card-dashboard" id="pjax-container">
                <div class="table-responsive">
                  <button id="generate" onClick="generateBackup($(this));" class="btn btn-success btn-flat" data-loading-text="{{ trans('backup.processing') }}"><span class="glyphicon glyphicon-plus"></span>{{ trans('backup.generate_now') }}</button></div>
                  <table id="main-table" class="table text-center align-middle" style=" width: 100%;">
                    <thead>
                    <tr>
