  ...
  <div class="col-md-6">
    ...
    <div class="box box-primary">
      <div class="box-header with-border">
        <h3 class="box-title">
          <div class="btn-group">
            <a class="main-action btn btn-warning btn-flat btn-sm menu-sort-save" title="Save"><i class="fa fa-save"></i><span class="hidden-xs">&nbsp;Save</span></a>
          </div>
      </h3>
            ...
            <li class="dd-item" data-id="{{ $level0->id }}">
                <div class="dd-handle header-fix">
                  ...
                  <span class="pull-right dd-nodrag">
                      <a href="{{ route('admin_menu.edit',['id'=>$level0->id]) }}"><i class="main-action fa fa-edit"></i></a>
                      <a data-id="{{ $level0->id }}" class="main-action remove_menu"><i class="fa fa-trash"></i></a>
                  </span>
                </div>
            </li>
          @elseif($level0->uri)
            <li class="dd-item" data-id="{{ $level0->id }}">
                <div class="dd-handle">
                  ...
                  <span class="pull-right dd-nodrag">
                      <a class='main-action' href="{{ route('admin_menu.edit',['id'=>$level0->id]) }}"><i class="fa fa-edit"></i></a>
                    ...
                    <div class="box-footer">
                        ...
                        <div class="col-md-8">
                            <div class="btn-group pull-right">
                                <button type="submit" class="main-action btn btn-primary">{{ trans('admin.submit') }}</button>
                            </div>
