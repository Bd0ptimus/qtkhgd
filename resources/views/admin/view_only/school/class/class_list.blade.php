                            ...
                            <div class="d-flex mb-1 justify-content-between">
                                <div class="d-flex">
                                    @if(Admin::user()->isAdministrator())
                                        <button class="btn btn-danger ag-grid-export-btn waves-effect waves-light mr-1 btn-delete-all">
                                ...
                                <div class="d-flex">
                                    ...
                                    <a type="button" id="create_category" name='create_category'
                                       class="ml-1 btn btn-flat btn-success"
                                ...
                                <table id="data-table" class="table nowrap zero-configuration">
                                    ...
                                    @foreach($school->classes as $key => $class)
                                        <tr data-id="{{$class->id}}">
                                            ...
                                            <td>
                                                <a type="button"
                                                   name='{{ $school->id }}' class="btn btn-flat btn-success"
                                                   href="{{  route('admin.school.edit_class', ['id' => $class->id])  }}">
                                                    <i class="fa fa-edit" aria-hidden="true"></i>
                                                </a>
                                                <a type="button"
                                                   name='{{ $school->id }}'
                                                   class="btn-delete-class btn btn-flat btn-danger"
                                                   href="#"
                                                   data-id="{{$class->id}}"
                                                >
