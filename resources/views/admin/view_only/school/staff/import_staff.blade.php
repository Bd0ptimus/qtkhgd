        ...
        <div class="row">
            <div class="col-12">
                <div class="alert alert-warning" role="alert">
                    <strong>Bước 1. </strong> Tải <a href="/demo_imports/file_import_nhan_vien.xls">File mẫu</a> về máy. <br>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Chọn file dữ liệu nhân viên</h4>
                    </div>
                    <div class="card-content">
                        <div class="card-body">
                            <form enctype="multipart/form-data" method="POST"
                                  action="{{ route('admin.school.import_staff', ['id' => $school->id ]) }}"
