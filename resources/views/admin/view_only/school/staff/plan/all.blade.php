            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">Kế hoạch giáo dục của <select class="btn btn-outline-success btn-datatable select-teacher">@foreach($school->staffs as $teacher)<option data-href="{{ route('school.staff.plans', ['school_id' => $school->id, 'staffId' => $teacher->id])}}" {{$staff->id == $teacher->id ? 'selected' : '' }}>{{ $teacher->fullname }}</option>@endforeach</select></div>
                    </div>
