                                        ...
                                        <div class="card card-school-plan collapse-icon accordion-icon-rotate">
                                            ...
                                            <div class="card-body">
                                                <div class="accordion" id="accordionExample">
                                                    ...
                                                    <br/>
                                                    <strong class="lead collapse-title">I. Phân phối chương trình</strong>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            @if($canManage)
                                                                                @if($teacherPlan->status == PLAN_APPROVED) 
                                                                                    <td><a style="margin-top: 3px" href="#" class="btn btn-flat btn-info btn-datatable"
                                                                                ...
                                                                                @endif
                                                                            @endif
                                                                            @foreach(['month_year', 'khoang_thoi_gian', 'bai_hoc', 'ten_bai_hoc', 'tiet_thu', 'so_tiet', 'thoi_diem', 'thiet_bi_day_hoc', 'dia_diem_day_hoc'] as $field)
                                                                                @if ($field === 'month_year')
                                                                                    <td>
                                                                                ...
                                                                                @elseif(in_array( $field, ['bai_hoc', 'ten_bai_hoc', 'thiet_bi_day_hoc', 'dia_diem_day_hoc'] ))
                                                                                    <td>
                                                                                        <textarea {{$teacherPlan->status == PLAN_APPROVED ? 'readonly' : '' }} name="lessons[{{$lesson->id}}][{{$field}}]" value="{{$lesson[$field]}}">{{$lesson[$field]}}</textarea>
                                                                                    </td>
                                                                                @else
                                                                                    <td>
                                                                                        <input {{$teacherPlan->status == PLAN_APPROVED ? 'readonly' : '' }} class="form-control" type="text" name="lessons[{{$lesson->id}}][{{$field}}]" value="{{$lesson[$field]}}">
                                                                                    </td>
                                                                                @endif
                                                                            @endforeach
                                                                        </tr>
                                                    ...
                                                    <br/>
                                                    <strong class="lead collapse-title"> II. Nhiệm vụ khác </strong>
