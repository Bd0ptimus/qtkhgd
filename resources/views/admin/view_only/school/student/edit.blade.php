            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-content">
                        ...
                        <form action="{{ route('admin.student.edit',$student->id) }}" method="post" class="form-row" id="form-main">
                              <div class="form-group col-md-6  {{ $errors->has('student_code') ? ' has-error' : '' }}">
                                    <label for="student_code" class=" control-label">Mã học sinh</label>       
                                    <input type="text" disabled  id="student_code" name="student_code" value="{{ old('student_code',$student['student_code']??'')}}" class="form-control" placeholder="" />
                              ...
                              <div class="form-group col-md-6  {{ $errors->has('dob') ? ' has-error' : '' }}">
                                    ...
                                    <input required type="date" id="dob" name="dob"  value="{{ old('dob',$student->getOriginal('dob') ?? '') }}" class="form-control" placeholder="" />
                                    @if ($errors->has('dob'))
                                        <span class="help-block"  style="color:red">
                                            {{ $errors->first('dob') }}
                                        </span>
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('gender') ? ' has-error' : '' }}">
                                    ...
                                    <option value=""></option>
                                        @foreach(\App\Models\Student::GENDER as $value => $position)
                                            <option value="{{$value}}" {{ $value == $student->getOriginal('gender') ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>                                   
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('ethnic') ? ' has-error' : '' }}">
                                        ...
                                        <option value=""></option>
                                          @foreach(\App\Models\Student::ETHNICS as $value => $position)
                                              <option value="{{$value}}" {{ $position == $student->ethnic ? 'selected' : '' }}>{{ $position }}</option>
                                          @endforeach
                                        </select>                                  
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('religion') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="religion">
                                        ...
                                        @foreach(\App\Models\Student::RELIGIONS as $value => $position)
                                            <option value="{{$value}}" {{ $position == $student->religion ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>                                      
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('nationality') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="nationality">
                                        ...
                                        @foreach(\App\Models\Student::NATIONALITIES as $value => $position)
                                            <option value="{{$value}}" {{ $position == $student->nationality ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('school_id') ? ' has-error' : '' }}">
                                    <label for="school_id" class="control-label">Trường</label>                        
                                    <select class="form-control" name="school_id">
                                        <option value=""></option>
                                        @foreach($schools as  $school)
                                            <option value="{{$school->id}}" {{ $school->id == $student->school_id ? 'selected' : '' }}>{{ $school->school_name }}</option>
                                        @endforeach
                                    </select>                                    
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('grade') ? ' has-error' : '' }}">
                                    <label for="grade" class="control-label">Khối</label>                        
                                    <select required class="form-control" name="grade">
                                        <option value=""></option>
                                        @foreach(\App\Models\SchoolClass::GRADES as $value => $position)
                                            <option value="{{$value}}" {{ $position == $student->grade ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>                                    
                                        @if ($errors->has('grade'))
                                            <span class="help-block"  style="color:red">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('disabilities') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="disabilities">
                                        @foreach(\App\Models\Student::DISABILITIES as $value => $position)
                                            <option value="{{$value}}" {{ $position == $student->disabilities ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>                                    
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('fptp') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="fptp">
                                        @foreach(\App\Models\Student::FPTP as $value => $position)
                                            <option value="{{$value}}" {{ $position == $student->fptp ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>                                    
                                        @if ($errors->has('fptp'))
                                            <span class="help-block"  style="color:red">
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('health_history') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="health_history">
                                        @foreach(\App\Models\Student::HEALTH_HISTORY as $value => $position)
                                            <option value="{{$value}}" {{ $position == $student->health_history ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>                                    
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('born_history') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="born_history">
                                        @foreach(\App\Models\Student::BORN_HISTORY as $value => $position)
                                            <option value="{{$value}}" {{ $position == $student->born_history ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>                                    
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('disease_history') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="disease_history">
                                        @foreach(\App\Models\Student::DISEASE_HISTORY as $value => $position)
                                            <option value="{{$value}}" {{ $position == $student->disease_history ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>                                    
                                ...
                                <div class="form-group col-md-6 {{ $errors->has('treating_disease') ? ' has-error' : '' }}">
                                    ...
                                    <select class="form-control" name="treating_disease">
                                        @foreach(\App\Models\Student::TREATING_DISEASE as $value => $position)
                                            <option value="{{$value}}" {{ $position == $student->treating_disease ? 'selected' : '' }}>{{ $position }}</option>
                                        @endforeach
                                    </select>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_bcg') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      ...
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_bcg" value="{{$value}}" {{ $value == $student->tc_bcg ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                          
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_bhhguv_m1') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_bhhguv_m1" value="{{$value}}" {{ $value == $student->tc_bhhguv_m1 ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                 
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_bhhguv_m2') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_bhhguv_m2" value="{{$value}}" {{ $value == $student->tc_bhhguv_m2 ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_bhhguv_m3') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_bhhguv_m3" value="{{$value}}" {{ $value == $student->tc_bhhguv_m3 ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_bailiet_m1') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_bailiet_m1" value="{{$value}}" {{ $value == $student->tc_bailiet_m1 ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_bailiet_m2') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_bailiet_m2" value="{{$value}}" {{ $value == $student->tc_bailiet_m2 ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_bailiet_m3') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_bailiet_m3" value="{{$value}}" {{ $value == $student->tc_bailiet_m3 ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_viemganb_m1') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_viemganb_m1" value="{{$value}}" {{ $value == $student->tc_viemganb_m1 ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_viemganb_m2') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_viemganb_m2" value="{{$value}}" {{ $value == $student->tc_viemganb_m2 ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_viemganb_m3') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_viemganb_m3" value="{{$value}}" {{ $value == $student->tc_viemganb_m3 ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_soi') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_soi" value="{{$value}}" {{ $value == $student->tc_soi ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                    
                              ...
                              <div class="form-group col-md-6 {{ $errors->has('tc_viemnaonb') ? ' has-error' : '' }}">
                                  ...
                                  <div class="col-md-6">
                                      @foreach(\App\Models\Student::TC_STATUS as $value => $position)
                                      <div class="custom-control custom-radio custom-control-inline">
                                          <input class="form-check-input" type="radio"  name="tc_viemnaonb" value="{{$value}}" {{ $value == $student->tc_viemnaonb ? 'checked' : '' }}>{{ $position }}</input>
                                      </div>
                                          @endforeach
                                  </div>                                        
