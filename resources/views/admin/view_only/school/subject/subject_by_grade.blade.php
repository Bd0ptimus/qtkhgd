                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            <div class="table-responsive">
                                <table class="table zero-configuration" id="school-subject-by-grade">
                                    <thead>
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td scope="row">
                                                @foreach($subjects as $index => $subject)
                                                    <button class="btn btn-outline-success btn-datatable">{{ $index + 1 }}. {{ $subject->name }}</button>
                                                @endforeach
                                            </td>
                                        </tr>
                                    @endforeach
...
@section('page-script')
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $('#school-subject-by-grade').DataTable();

            $('#school-subject-by-grade').on('click','.delete-item',function (e) {
                e.preventDefault();
